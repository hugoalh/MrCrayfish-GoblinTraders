 ...
 * Author: MrCrayfish
 */
public class AncientLootingEnchantment extends Enchantment implements IAncientEnchantment
{
    private final Enchantment original;

    public AncientLootingEnchantment(EnchantmentDefinition definition, Enchantment original)
    {
        super(definition);
    ...
    {
        return super.checkCompatibility(enchantment) && enchantment != Enchantments.SILK_TOUCH && enchantment != this.original;
    }
