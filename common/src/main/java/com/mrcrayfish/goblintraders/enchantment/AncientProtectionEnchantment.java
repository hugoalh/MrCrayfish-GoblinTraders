 ...
 * Author: MrCrayfish
 */
public class AncientProtectionEnchantment extends ProtectionEnchantment implements IAncientEnchantment
{
    private final Enchantment original;

    public AncientProtectionEnchantment(EnchantmentDefinition definition, Type type, Enchantment original)
    {
    ...
    {
        return super.getDamageProtection(this.getAncientLevel(level), source);
    }
